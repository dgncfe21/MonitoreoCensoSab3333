...
var cars_Ref = firebase.database().ref('/LAMPARAS_E3vsab');


var dataConductores = firebase.database().ref('/LAMPARAS_E3vsab');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E3sab');
